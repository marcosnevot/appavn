    ...
    public function store(Request $request)
{
    try {
        ...
        $validated = $request->validate([
            ...
            'asunto_id' => 'nullable|exists:asuntos,id', // Validar si el asunto ya existe
            'asunto_nombre' => 'nullable|string', // Nombre del nuevo asunto
        ...
        if (!$validated['asunto_id'] && !empty($validated['asunto_nombre'])) {
            $asunto = Asunto::create(['nombre' => $validated['asunto_nombre']]);
